...
|---|---|---|
| `ANS_API_KEY`, `ANS_API_SECRET` | `generate_agents.py` | GoDaddy ANS credentials. See `docs/design/ans-integration.md`. |
| `ANS_API_ENDPOINT` | optional | Defaults to `https://api.godaddy.com`. |
